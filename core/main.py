...
@app.command("chat", help="Starts an interactive chat session with the configured Synapse agent.")
@app.command("", hidden=True)  # Make chat the default command
def chat():
    """
    ...
    while True:
        try:
            ...
            if tool_call:
                ...
                print(f"\U0001f6e0\ufe0f  Invoking tool: {function_name}(**{arguments})")
